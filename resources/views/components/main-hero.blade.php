<header>
    <div class="w-full bg-center bg-cover h-128 font-semibold" 
        ...
        <div class="flex items-center justify-center w-full h-full bg-gray-900 bg-opacity-50">
            <div class="text-center">
                <div class="border border-gray-300 p-6 grid grid-cols-1 gap-6 bg-white shadow-lg rounded-md">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="grid grid-cols-2 gap-2 p-2">
                            <div class="flex border rounded bg-gray-200 items-center p-2 ">
                                ...
                                <input type="text" placeholder="Enter text here..."
                                       class="bg-gray-200 max-w-full focus:outline-none text-gray-800 border-none focus:ring-0"/>
                            </div>
                            <div class="flex border rounded bg-gray-200 items-center p-2 ">
                                <svg  class="fill-current text-gray-800 mr-2 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
                                    <path class="heroicon-ui"
                    ...
                    <div class="flex justify-center">
                        <button class="p-2 border w-1/4 rounded-md bg-gray-800 text-gray-200 hover:bg-primary-green">
                            Search
                        </button>
                    </div>
                </div>
